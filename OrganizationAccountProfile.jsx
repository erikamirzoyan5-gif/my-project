...
function OrganizationAccountProfile() {
  ...
  const handleSaveProfile = async () => {
    ...
    console.log("Organization profile saved:", { ...userInfo, interests: userInterests });
    navigate("/organization-dashboard"); // Տանում է organization dashboard
  };
  ...
  return (
    <div className="account-profile-page">
        ...
        <div className="profile-info-container">
          ...
          <div className="profile-main-info">
            <div className="name-section">
              ...
              <input
                type="text"
                placeholder="Organization Type / Headline"
        ...
        <div className="content-grid">
          ...
          <div className="sidebar-column">
            ...
            <div className="profile-section">
              ...
              <textarea
                placeholder="Share your organization's story, mission, and what drives you..."
          ...
          <div className="main-column">
                    ...
                    <div key={post.id} className="post-item">
                      <div className="post-header">
                        ...
                        <div className="post-author-info">
                          <div className="post-author-name">{userInfo.name || "Organization"}</div>
            ...
            <div className="profile-section">
              ...
              <div className="experience-form">
                ...
                <textarea
                  placeholder="Describe your organization's activities and achievements..."
      ...
      <div className="profile-actions-footer">
        <button className="secondary-btn" onClick={() => navigate("/organization-dashboard")}>
          Preview Profile
        </button>
